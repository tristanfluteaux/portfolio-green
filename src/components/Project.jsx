    ...
    toggleCategories(){
        ...
        return (
            ...
            <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
                ...
                <CardActions border>
                    <Button href='https://github.com/tristanfluteaux/chickennuggets' colored>Github</Button>
                    <Button href='https://simmer.io/@DanForstesque/chicken-nuggets' colored>Link</Button>
                </CardActions>
                <CardMenu style={{color: '#fff'}}>
                </CardMenu>
            </Card>

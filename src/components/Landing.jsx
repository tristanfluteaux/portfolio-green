    ...
    <>
      <div className="landing-main">
        <Grid className={gradientColor ? "landing-grid" : "landing-grid-dm"}>
          <Cell col={12}>
            <img src={profilPic} alt="avatar" className="avatar-img" />
            <div className="banner-text">
              <h1 className="name">Tristan Fluteaux</h1>
              <h1>
                Développeur web FullStack{" "}
                <span style={{ color: "yellow" }}>{loop}</span>
              </h1>
              ...
              <div className="social-links">
                {/* LinkedIn */}
                <a
                  href="https://www.linkedin.com/in/tristan-fluteaux/"
                ...
                {/* Github */}
                <a
                  href="https://github.com/tristanfluteaux"
                  rel="noopener noreferrer"
                  target="_blank"
                >
